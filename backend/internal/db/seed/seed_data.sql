...
WITH seed_users(id, username, created_at, updated_at) AS (
    VALUES
        ('00000000-0000-4000-8000-000000000001'::uuid, 'test_user', now() - interval '1 day', now()),
        ('00000000-0000-4000-8000-000000000002'::uuid, 'kuroda_kayn', now() - interval '30 days', now()),
        ('00000000-0000-4000-8000-000000000003'::uuid, 'tech_weekly', now() - interval '15 days', now())
),
inserted_users AS (
    INSERT INTO users (id, username, created_at, updated_at)
    SELECT su.id, su.username, su.created_at, su.updated_at
    FROM seed_users su
    WHERE NOT EXISTS (
        SELECT 1
        FROM users u
...
seed_publications(
    ...
    VALUES
        ...
        (
            ...
            true,
            'pending',
            '{"title":"Vision Pro 2 代体验","tags":["好物分享","数码科技"]}'::jsonb,
            '{"summary":"佩戴更舒服，沉浸感更自然。","format":"text"}'::jsonb,
            NULL,
            NULL,
            NULL,
            0,
